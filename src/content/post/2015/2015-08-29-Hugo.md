...
我的Hugo博客：[http://ericbaranowski.netlify.com/](http://ericbaranowski.netlify.com/)
...
### 遇到的问题
 ...
 1. URL全部被转成了小写，如果是旧博客迁移过来，将是无法接受的。
  解决方法：~~我是直接改了Hugo的代码，将URL强制转换为小写那段逻辑去掉了，之后考虑在config里提供配置开关，然后给Hugo提一个PR。如果是Windows用户可以直接[https://github.com/ericbaranowski/ConvertToHugo](https://github.com/ericbaranowski/ConvertToHugo) 下载到我修改后的版本myhugo.exe。~~
...
假如你之前的博客和我一样是Jekyll的，可以尝试使用我写的[ConvertToHugo.py](https://github.com/ericbaranowski/ConvertToHugo/blob/master/ConvertToHugo.py) 工具。这个转换工具逻辑相对比较简单和清晰，如果满足不了你的需求你也可以轻易在此基础上做些修改，如果我能收到PR当然是最好了。

反正，我是完全使用CovertToHugo.py将我原来的Jekyll博客全部转过来了。而且，我找到了一个非常炫酷的主题，并且在此基础稍微修改下。

![HugoBlog](http://image.coderzh.com/HugoBlog.jpg)

Blog地址：[http://ericbaranowski.netlify.com](http://ericbaranowski.netlify.com)

Github: [https://github.com/ericbaranowski/coderzh-hugo-blog](https://github.com/ericbaranowski/coderzh-hugo-blog)
...
$ cd public
$ git init
$ git remote add origin https://github.com/ericbaranowski/coderzh.github.io.git
$ git add -A
...
自动部署的脚本可以参考我的Repo里的`deploy.py`脚本：[https://github.com/ericbaranowski/coderzh-hugo-blog](https://github.com/ericbaranowski/coderzh-hugo-blog)

全自动化部署到GitHub和GitCafe，见我的另一篇博客：[通过webhook将Hugo自动部署至GitHub Pages和GitCafe Pages](http://ericbaranowski.netlify.com/2015/09/13/use-webhook-automated-deploy-hugo/)
